      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>
            Example <Text style={{color: '#0742fc'}}>Face ID</Text>
          </Text>

          <Text style={styles.subtitle}>Test login here...</Text>
        </View>
